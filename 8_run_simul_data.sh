#---
# title: Run simulation on real data for all markers (haploid individuals to create parents of the pool)
#---
...
cp ${snp_list} ${dirin}/${prefix}/snp_list.txt
...
awk '{print$1" "$2}' ${dirin}/${freq} > ${dirin_simul}/snp.txt
...
sed -i -e "s/${chr[0]}/1/g" -e "s/${chr[1]}/2/g" -e "s/${chr[2]}/3/g" -e "s/${chr[3]}/4/g" -e "s/${chr[4]}/5/g" -e "s/${chr[5]}/6/g" -e "s/${chr[6]}/7/g" -e "s/${chr[7]}/8/g" -e "s/${chr[8]}/9/g" -e "s/${chr[9]}/10/g" -e "s/${chr[10]}/11/g" -e "s/${chr[11]}/12/g" -e "s/${chr[12]}/13/g" -e "s/${chr[13]}/14/g" -e "s/${chr[14]}/15/g" -e "s/${chr[15]}/16/g" ${dirin_simul}/Depth_simul_data_recode.txt
...
sed -i -e "s/${chr[0]}/1/g" -e "s/${chr[1]}/2/g" -e "s/${chr[2]}/3/g" -e "s/${chr[3]}/4/g" -e "s/${chr[4]}/5/g" -e "s/${chr[5]}/6/g" -e "s/${chr[6]}/7/g" -e "s/${chr[7]}/8/g" -e "s/${chr[8]}/9/g" -e "s/${chr[9]}/10/g" -e "s/${chr[10]}/11/g" -e "s/${chr[11]}/12/g" -e "s/${chr[12]}/13/g" -e "s/${chr[13]}/14/g" -e "s/${chr[14]}/15/g" -e "s/${chr[15]}/16/g" ${dirin_simul}/Count_ref_simul_data_recode.txt
...
sed -i -e "s/${chr[0]}/1/g" -e "s/${chr[1]}/2/g" -e "s/${chr[2]}/3/g" -e "s/${chr[3]}/4/g" -e "s/${chr[4]}/5/g" -e "s/${chr[5]}/6/g" -e "s/${chr[6]}/7/g" -e "s/${chr[7]}/8/g" -e "s/${chr[8]}/9/g" -e "s/${chr[9]}/10/g" -e "s/${chr[10]}/11/g" -e "s/${chr[11]}/12/g" -e "s/${chr[12]}/13/g" -e "s/${chr[13]}/14/g" -e "s/${chr[14]}/15/g" -e "s/${chr[15]}/16/g" ${dirin_simul}/snp.txt
...
sed -i -e "s/${chr[0]}/1/g" -e "s/${chr[1]}/2/g" -e "s/${chr[2]}/3/g" -e "s/${chr[3]}/4/g" -e "s/${chr[4]}/5/g" -e "s/${chr[5]}/6/g" -e "s/${chr[6]}/7/g" -e "s/${chr[7]}/8/g" -e "s/${chr[8]}/9/g" -e "s/${chr[9]}/10/g" -e "s/${chr[10]}/11/g" -e "s/${chr[11]}/12/g" -e "s/${chr[12]}/13/g" -e "s/${chr[13]}/14/g" -e "s/${chr[14]}/15/g" -e "s/${chr[15]}/16/g" ${dirin_simul}/snp_list.txt
chr=($(seq 1 1 16))
...
do
	...
	if [ ${i} -lt ${Ncol} ]
	then
	sbatch -J ${i}_qg_pool${n} --mem=50G --wrap=".local/bin/qg_pool --Fmatrix ${dirin_simul}/${freq} ${dirin_simul}/sim_depth_count${n}.txt --extract ${dirin_simul}/snp_list.txt -o ${dirout_simul}"
	else
	sbatch -W -J ${i}_qg_pool${n} --mem=50G --wrap=".local/bin/qg_pool --Fmatrix ${dirin_simul}/${freq} ${dirin_simul}/sim_depth_count${n}.txt --extract ${dirin_simul}/snp_list.txt -o ${dirout_simul}"
	fi
	let "n+=1"
done
...
############################################################################################
# Prep ADMIXTURE (50 000 reference SNPs)
############################################################################################
n_marker_list=$(wc -l < ${dirin_simul}/snp_list.txt)
cp ${dirin_simul}/snp_list.txt  ${dirin_simul}/list_marker.txt
cp ${dirin_simul}/Geno_queen_simul_data.txt ${dirin_simul}/geno_queen.txt
grep -Fwf ${dirin_simul}/list_marker.txt ${dirin_simul}/geno_queen.txt > ${dirin_simul}/tmp && mv ${dirin_simul}/tmp ${dirin_simul}/geno_queen.txt
...
grep -Fwf ${dirin_simul}/list_marker.txt ${dirin_simul}/allele_id.txt > ${dirin_simul}/tmp.txt && mv ${dirin_simul}/tmp.txt ${dirin_simul}/allele_id.txt
sed 's: :,:g' ${dirin_simul}/list_marker.txt > ${dirin_simul}/list_marker2.txt
grep -Fwf ${dirin_simul}/list_marker2.txt ${dirin_simul}/geno_ref.txt > ${dirin_simul}/tmp.txt && mv ${dirin_simul}/tmp.txt ${dirin_simul}/geno_ref.txt
...
############################################################################################
# Run ADMIXTURE on simulated real data
############################################################################################
